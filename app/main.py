...
def main():  
    ...
    # 识别棋子 
    pieces = recognition.pieces_recognition(image, gray)
    ...
    if not utils.check_repeat_position(position, last_position, is_red):
        return 'repeat'
    ...
    # 向引擎发送命令
    move, fen = engine.get_best_move(fen_str, is_red)
    print(f'{fen}\n{move}')
